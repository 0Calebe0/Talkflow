...
3. **Instale as dependências do backend**: Execute os comandos abaixo no terminal para configurar o projeto e baixar as bibliotecas necessárias:
   ```bash
   # 1. Cria o arquivo package.json (gerenciador do projeto)
   npm init -y
